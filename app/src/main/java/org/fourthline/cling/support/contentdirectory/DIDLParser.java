...
public class DIDLParser extends SAXParser {
    ...
    protected ContainerHandler createContainerHandler(Container container, Handler handler) {
        return new ContainerHandler(container, handler);
    }

    protected ItemHandler createItemHandler(Item item, Handler handler) {
        return new ItemHandler(item, handler);
    }

    protected ResHandler createResHandler(Res res, Handler handler) {
        return new ResHandler(res, handler);
    }

    protected DescMetaHandler createDescMetaHandler(DescMeta descMeta, Handler handler) {
    ...
    protected void generateContainer(Container container, Document document, Element element, boolean z) {
        ...
        appendProperties(document, appendNewElement, container, "upnp", (Class<? extends DIDLObject.Property.NAMESPACE>) DIDLObject.Property.UPNP.NAMESPACE.class, DIDLObject.Property.UPNP.NAMESPACE.URI);
        appendProperties(document, appendNewElement, container, "dc", (Class<? extends DIDLObject.Property.NAMESPACE>) DIDLObject.Property.DC.NAMESPACE.class, DIDLObject.Property.DC.NAMESPACE.URI);
        if (z) {
    ...
    protected void generateItem(Item item, Document document, Element element) {
        ...
        appendProperties(document, appendNewElement, item, "upnp", (Class<? extends DIDLObject.Property.NAMESPACE>) DIDLObject.Property.UPNP.NAMESPACE.class, DIDLObject.Property.UPNP.NAMESPACE.URI);
        appendProperties(document, appendNewElement, item, "dc", (Class<? extends DIDLObject.Property.NAMESPACE>) DIDLObject.Property.DC.NAMESPACE.class, DIDLObject.Property.DC.NAMESPACE.URI);
        appendProperties(document, appendNewElement, item, Descriptor.Device.SEC_PREFIX, (Class<? extends DIDLObject.Property.NAMESPACE>) DIDLObject.Property.SEC.NAMESPACE.class, DIDLObject.Property.SEC.NAMESPACE.URI);
    ...
    public abstract class DIDLObjectHandler<I extends DIDLObject> extends Handler<I> {
        ...
        public void endElement(String str, String str2, String str3) throws SAXException {
            ...
            if (DIDLObject.Property.DC.NAMESPACE.URI.equals(str)) {
                ...
                } else if (MediaTrack.ROLE_DESCRIPTION.equals(str2)) {
    ...
    public class ResHandler extends Handler<Res> {
