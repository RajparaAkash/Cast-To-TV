...
public final class AppData {
    ...
    private String DEFAULT_SERVER_PORT = "8085";
    ...
    public AppData(Context context) {
        ...
        this.mServerPort = Integer.parseInt(defaultSharedPreferences.getString(context.getString(R.string.pref_key_server_port), this.DEFAULT_SERVER_PORT));
        this.mClientTimeout = Integer.parseInt(defaultSharedPreferences.getString(context.getString(R.string.pref_key_client_con_timeout), DEFAULT_CLIENT_TIMEOUT));
        this.mJpegQuality = Integer.parseInt(defaultSharedPreferences.getString(context.getString(R.string.pref_key_jpeg_quality), DEFAULT_JPEG_QUALITY));
    }
